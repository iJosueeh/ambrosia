...
import com.ambrosia.ambrosia.services.admin.AdminForumService;
...
public class AdminForumController {
    ...
    public ResponseEntity<ForumAdminDTO> getTopicById(@PathVariable Long id) {
        ForumAdminDTO topic = adminForumService.getForumById(id);
        return ResponseEntity.ok(topic);
    }

    @PutMapping("/topics/{id}/status")
    public ResponseEntity<ForumAdminDTO> updateTopicStatus(@PathVariable Long id, @RequestParam String newStatus) {
    ...
    public ResponseEntity<CommentAdminDTO> getCommentById(@PathVariable Long id) {
        CommentAdminDTO comment = adminForumService.getCommentById(id);
        return ResponseEntity.ok(comment);
    }

    @PutMapping("/comments/{id}/status")
    public ResponseEntity<CommentAdminDTO> updateCommentStatus(@PathVariable Long id, @RequestParam String newStatus) {
